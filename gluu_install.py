...
if not argsp.u:
    ...
    download(maven_base + '/org/gluu/super-gluu-radius-server/4.3.1-SNAPSHOT/super-gluu-radius-server-4.3.1-SNAPSHOT.jar', os.path.join(gluu_app_dir, 'super-gluu-radius-server.jar'))
    ...
    download(maven_base + '/org/gluu/super-gluu-radius-server/4.3.1-SNAPSHOT/super-gluu-radius-server-4.3.1-SNAPSHOT-distribution.zip', os.path.join(gluu_app_dir, 'gluu-radius-libs.zip'))
