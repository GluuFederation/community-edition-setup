...
if not argsp.u:
    ...
    download('https://raw.githubusercontent.com/GluuFederation/casa/version_{}/plugins/account-linking/extras/login.xhtml'.format(app_versions['PASSPORT_VERSION']), os.path.join(gluu_app_dir,'login.xhtml'))
    download('https://raw.githubusercontent.com/GluuFederation/casa/version_{}/plugins/account-linking/extras/casa.py'.format(app_versions['PASSPORT_VERSION']), os.path.join(gluu_app_dir,'casa.py'))
    ...
    download('https://raw.githubusercontent.com/GluuFederation/oxd/version_{}/debian/oxd-server'.format(app_versions['PASSPORT_VERSION']), os.path.join(gluu_app_dir,'oxd-server-start.sh'))
