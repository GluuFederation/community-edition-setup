...
class CollectProperties(SetupUtils, BaseInstaller):
    ...
    def collect(self):
        ...
        if oxTrustConfApplication.get('ScimProperties') != None and 'protectionMode' in oxTrustConfApplication['ScimProperties']:
        ...
        if oxTrustConfApplication.get('scimUmaClientKeyStorePassword') != None:
