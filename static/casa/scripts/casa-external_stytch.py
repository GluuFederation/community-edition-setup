...
class PersonAuthentication(PersonAuthenticationType):
    ...
    def init(self, customScript, configurationAttributes):
        ...
        if not configurationAttributes.containsKey("DELETE_USER_ENDPOINT"):
            print "Stytch. Initialization. Property DELETE_USER_ENDPOINT is mandatory"
            return False
        self.DELETE_USER_ENDPOINT = configurationAttributes.get("DELETE_USER_ENDPOINT").getValue2()
    ...
    def authenticate(self, configurationAttributes, requestParameters, step):
        ...
        if step == 1:
            ...
            try:
                foundUser = authenticationService.getAuthenticatedUser()
                user_name = foundUser.getUserId()
            except:
                print("Stytch Error retrieving user  from LDAP")
                return False
    ...
    def sendPasscodeSMSToUser(self, phoneNumber):
        ...
        try:
            ...
            if not httpService.isResponseStastusCodeOk(http_response):
                ...
                print "response %s - " % response_string
                return None
            else :
